...
import dev.jefferson.email.services.exceptions.AuthorizationException;
import dev.jefferson.email.services.exceptions.DataBindingViolationException;
import dev.jefferson.email.services.exceptions.ObjectNotFoundException;
...
@Slf4j(topic = "APPLICATION_EXCEPTION_HANDLER")
@ControllerAdvice
